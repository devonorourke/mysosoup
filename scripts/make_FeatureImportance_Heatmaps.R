...
ggsave("FigureX_RelativeFeatureImportance_CoreFeatures_wAbundances.png", height=20, width = 35, units="cm")
ggsave("FigureX_RelativeFeatureImportance_CoreFeatures_wAbundances.pdf", height=29, width = 35, units="cm")
