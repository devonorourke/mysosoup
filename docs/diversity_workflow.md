...
- Table 2: [coreOTU_summary.csv](https://raw.githubusercontent.com/devonorourke/mysosoup/master/data/taxonomy/coreOTU_summary.csv). What is the taxonomic inforamtion assigned to each OTU among the 56 core features, and how many samples were they detected in?
