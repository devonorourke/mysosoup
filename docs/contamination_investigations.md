...
Trace amounts of contaminant solid guano or liquid extract could produce moderate sequence counts for a few reasons
  ...
  - DNA extracts were normalized prior to amplification, and then PCR products were normalized again prior to pooling. Thus if PCR was even moderately successful for negative control samples and generated a relatively low concentration compared to most guano samples, these differences were erased prior to pooling.
